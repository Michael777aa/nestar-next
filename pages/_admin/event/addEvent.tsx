			...
			<Stack>
				<Stack className="description-box">
					...
					<input
						...
						onChange={({ target: { value } }) => setEventData({ ...eventData, eventName: value })}
					/>

					<Stack className="config-row">
						<Stack className="price-year-after-price">
							<Typography className="title">Topic</Typography>
							<input
								type="text"
								className="description-input"
								placeholder={'Topic'}
								value={eventData.eventTopic}
								onChange={({ target: { value } }) => setEventData({ ...eventData, eventTopic: value })}
							/>
						</Stack>
					</Stack>
					<Stack className="config-row">
						<Stack className="price-year-after-price">
							...
							<input
								...
								onChange={({ target: { value } }) => setEventData({ ...eventData, eventLocation: value })}
							/>
						</Stack>
					</Stack>
					<Stack className="config-row">
						<Stack className="price-year-after-price">
							...
							<input
								...
								onChange={({ target: { value } }) => setEventData({ ...eventData, eventDesc: value })}
							/>
						</Stack>
					</Stack>
					...
					<Stack>
						<Button className="next-button" disabled={doDisabledCheck()} onClick={insertEventHandler}>
